...
export default function MovieCard({ title, overview, movieId, watchList, watchListId, youtubeUrl, age, time, year }: iAProps) {
    ...
    return (
        <>
            ...
            <div className="p-5 absolute bottom-0 left-0">
                ...
                <p className="line-clamp-1 text-sm text-gray-200 text-light">{overview}</p>
            </div>
            <PlayVideoModal 
